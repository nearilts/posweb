                    ...
                    <tr>
                      ...
                      <td>    
                        ...
                        <div class="btn-group">
                          ...
                          <a  href="{{route('transaction.edit',$d)}}" class="btn btn-warning btn-sm" > <i class="fa fa-edit"></i></a>
                        ...
                        {{-- <div class="modal fade" id="edit_pembelian_{{ $d['id'] }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabels" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <h4 class="modal-title" id="exampleModalLabels">Edit Penjualan</h4>
                              </div>
